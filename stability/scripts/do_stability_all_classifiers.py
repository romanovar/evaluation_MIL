...
# stability_all_classifiers(config, classifiers, only_segmentation_images=True, only_positive_images=False,
...
# stability_all_classifiers_instance_level(config, classifiers, only_segmentation_images=False, only_positive_images=True)
